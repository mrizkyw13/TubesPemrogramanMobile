...
export default class PostEditScreen extends Component {
    ...
    delete() {
        Axios.delete(`http://10.0.2.2:3000/posts/id/`+this.state.id,{
            post : this.state.bio,
            id : this.state.id
        }).then((response) => {
                    ...
                    <View style={styles.footer}>
                        <TouchableOpacity onPress={() => this.delete()}>
                            <View style={styles.btnPic}>
                                <Text style={styles.btnTextPic}>Delete</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => navigation.navigate('EditStack',{itemId:this.state.id})}>
                            <View style={styles.btnPic}>
                                <Text style={styles.btnTextPic}>Edit</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
